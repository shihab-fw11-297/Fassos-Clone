  ...
  const foodItems2 = [
    {
      ...
      rating: 4.5,
      boughtTimes: '296',
      description: '(Serves 1) Your favourite combination - L...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Super Saver Chicken Bhuna..',
      img_src:
      ...
      boughtTimes: '220',
      description:
        '(Serves 1) Time to unwrap big savings w...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
...
if (localStorage.getItem('list3') == null) {
  const foodItems3 = [
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Double Value Creamy Veg Wra...',
      img_src: 'https://b.zmtcdn.com/data/pictures/chains/9/19204539/aa69e849cb33f18fecb937170a204f69.jpg',
      price: 545,
      rating: 4.5,
      boughtTimes: '296',
      description: '(Serves 2) Double the excitement, double...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Double Value Veg Delight Meal',
      img_src:
      ...
      boughtTimes: '220',
      description:
        '(Serves 2) 131 is your lucky number thats ...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
  ...
  const foodItems4 = [
    {
      ...
      rating: 4.5,
      boughtTimes: '296',
      description: '(Serves 4) Definite fun & savings of Rs.24...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Family Saver Veg+Non Veg...',
      img_src:
      ...
      boughtTimes: '220',
      description:
        '(Serves 4) This is stairway to food heaven! ...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
...
if (localStorage.getItem('list5') == null) {
  const foodItems3 = [
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Limited Period Creamy Dahi..',
      img_src: 'https://b.zmtcdn.com/data/pictures/chains/9/19204539/aa69e849cb33f18fecb937170a204f69.jpg',
      price: 184,
      rating: 4.5,
      boughtTimes: '296',
    ...
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Limited Period Chatpata Kacche...',
      img_src:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4W9pjQyJck9jKtSeW1JA7ZOAthW_gexE24uJ3c3_i7u7UTm3UeNgju6X9zkIh7Gmt-cI&usqp=CAU',
      price: 131,
      rating: 5,
...
if (localStorage.getItem('list6') == null) {
  const foodItems2 = [
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Non-Veg Signature Meal...',
      img_src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRF0wequQ1licbFXPz2IrNKrA90g2wgC6BPFdye6GVRmIq0XBd2ImiNk1_mjCoHFxES-to&usqp=CAU',
      price: 314,
      rating: 4.5,
      boughtTimes: '296',
      description: '(Serves 1) 1 Veg Signature Wrap + Start...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: 'Veg Signature Meal Combo',
      img_src:
        'https://d4t7t8y8xqo0t.cloudfront.net/resized/720X280/restaurant%2F670925%2Frestaurant020200418042409.jpg',
      price: 282,
      rating: 5,
      boughtTimes: '220',
      description:
        '(Serves 1) 1 Veg Signature Wrap + Start  ...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
...
if (localStorage.getItem('list7') == null) {
  const foodItems1 = [
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: '2 Classic Veg Wraps at 269',
      img_src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTruvk4S2Snt1pnnZyVCoVaspjOnixXmjBl1_uOmE4tawnAlWVYdKGoqA60u-zoOUC-cNk&usqp=CAU',
      price: 269,
      rating: 4.5,
      boughtTimes: '296',
      description: 'The classics but better! Bigger savings, sa...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      name: '2 Classic Non-Veg Wraps at 299',
      img_src:
        'https://i1.wp.com/cdn.whatsuplife.in/pune/listing/0_1541320686-96.jpg',
      price: 349,
      rating: 5,
  ...
  const foodItems2 = [
    {
      ...
      rating: 4.5,
      boughtTimes: '296',
      description: 'When you dont know what to eat next w...',
      veg_nonVeg: 'veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
      ...
      boughtTimes: '220',
      description:
        '[100% Safely Cooked Chicken] Juicy min...',
      veg_nonVeg: 'Non-veg',
    },
    {
      packdetails: 'Daily Value Wrap Combos (Save Upto 40% Extra)',
